import { getAuth, signOut, updateEmail, updateProfile } from '@react-native-firebase/auth';
    ...
    <>
      <AppScreen tab="more">
        ...
        <AppCard>
          ...
          {!synthetic ? <AppButton label="Çıkış yap" variant="text" expand onPress={() => void signOut(getAuth())} /> : null}
        </AppCard>
